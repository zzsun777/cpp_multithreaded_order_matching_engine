#ifndef FIX44_POSITIONREPORT_H
#define FIX44_POSITIONREPORT_H
...
namespace FIX44
{
  ...
  public:
    ...
    PositionReport(
      ...
      const FIX::PosReqResult& aPosReqResult,
      const FIX::ClearingBusinessDate& aClearingBusinessDate,
      const FIX::Account& aAccount,
      const FIX::AccountType& aAccountType,
      const FIX::SettlPrice& aSettlPrice,
      const FIX::SettlPriceType& aSettlPriceType,
      const FIX::PriorSettlPrice& aPriorSettlPrice )
    : Message(MsgType())
    {
      set(aPosMaintRptID);
      set(aPosReqResult);
    ...
    {
    public:
    NoUnderlyings() : FIX::Group(711,311,FIX::message_order(311,312,309,305,462,463,310,763,313,542,315,241,242,243,244,245,246,256,595,592,593,594,247,316,941,317,436,435,308,306,362,363,307,364,365,877,878,318,879,810,882,883,884,885,886,732,733,0)) {}
