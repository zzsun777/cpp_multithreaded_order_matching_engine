#ifndef FIX44_POSITIONMAINTENANCEREPORT_H
#define FIX44_POSITIONMAINTENANCEREPORT_H
...
namespace FIX44
{
  ...
  public:
    ...
    PositionMaintenanceReport(
      ...
      const FIX::OrigPosReqRefID& aOrigPosReqRefID,
      const FIX::PosMaintStatus& aPosMaintStatus,
    ...
    FIELD_SET(*this, FIX::PosMaintStatus);
    FIELD_SET(*this, FIX::PosMaintResult);
