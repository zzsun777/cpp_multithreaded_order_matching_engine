#ifndef FIX44_ASSIGNMENTREPORT_H
#define FIX44_ASSIGNMENTREPORT_H
...
namespace FIX44
{
  ...
  public:
    ...
    AssignmentReport(
      ...
      const FIX::UnderlyingSettlPrice& aUnderlyingSettlPrice,
      const FIX::AssignmentMethod& aAssignmentMethod,
      const FIX::OpenInterest& aOpenInterest,
      const FIX::ExerciseMethod& aExerciseMethod,
