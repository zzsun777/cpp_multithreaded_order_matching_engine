#ifndef FIX50SP2_TRADECAPTUREREPORTREQUESTACK_H
#define FIX50SP2_TRADECAPTUREREPORTREQUESTACK_H
...
namespace FIX50SP2
{
  ...
  public:
    ...
    TradeCaptureReportRequestAck(
      ...
      const FIX::TradeRequestResult& aTradeRequestResult,
      const FIX::TradeRequestStatus& aTradeRequestStatus )
    : Message(MsgType())
    {
      set(aTradeRequestID);
    ...
    FIELD_SET(*this, FIX::TradeRequestResult);
    FIELD_SET(*this, FIX::TradeRequestStatus);
