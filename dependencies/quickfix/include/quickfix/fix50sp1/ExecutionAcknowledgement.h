#ifndef FIX50SP1_EXECUTIONACKNOWLEDGEMENT_H
#define FIX50SP1_EXECUTIONACKNOWLEDGEMENT_H
...
namespace FIX50SP1
{
  ...
  public:
    ...
    ExecutionAcknowledgement(
      ...
      const FIX::ExecAckStatus& aExecAckStatus,
    ...
    FIELD_SET(*this, FIX::ExecAckStatus);
