#ifndef FIX50SP1_CONTRARYINTENTIONREPORT_H
...
namespace FIX50SP1
{
  ...
  public:
    ...
    ContraryIntentionReport(
      const FIX::ContIntRptID& aContIntRptID,
    ...
    FIELD_SET(*this, FIX::ContIntRptID);
    FIELD_SET(*this, FIX::TransactTime);
    FIELD_SET(*this, FIX::LateIndicator);
    FIELD_SET(*this, FIX::InputSource);
    ...
    FIELD_SET(*this, FIX::NoExpiration);
    class NoExpiration: public FIX::Group
    {
    public:
    NoExpiration() : FIX::Group(981,982,FIX::message_order(982,983,0)) {}
      FIELD_SET(*this, FIX::ExpirationQtyType);
      FIELD_SET(*this, FIX::ExpQty);
    };
